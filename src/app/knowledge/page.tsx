      ...
      <section className="relative bg-dark-bg text-white cyberpunk-overlay">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-neon-blue mb-8 cyberpunk-glow">
              {t("kb.subtitle")}
            </p>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filteredArticles.length > 0 ? (
                  ...
                  <div className="col-span-full py-12 text-center">
                    <svg className="mx-auto h-12 w-12 text-neon-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="bg-dark-bg py-12 border-t border-neon-blue border-opacity-20 relative overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="cyberpunk-title text-2xl font-bold text-white mb-4" data-text={t("kb.stayUpdated")}>
              {t("kb.stayUpdated")}
            </h2>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-center gap-3">
              ...
              />
              <button className="cyberpunk-button px-6 py-2 rounded-md">
                {t("kb.subscribe")}
              </button>
            </div>
          </div>
