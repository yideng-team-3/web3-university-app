...
const NeonCard: React.FC<{children: React.ReactNode}> = ({ children }) => (
  <div className="relative p-8 rounded-3xl bg-transparent border border-[#00ffff] shadow-lg transition-all duration-300 hover:border-[#ff00ff] group max-w-[480px] mb-4">
    ...
    <NeonCard>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-gray-300">
          <p>
            ...
            <AnimatedNumber 
              value={getSafeYdBalance(ydBalance)}
              format="integer" 
            />
          </p>
        </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex-1 flex items-center">
          <label htmlFor="amount-input" className="block text-gray-300 whitespace-nowrap">
